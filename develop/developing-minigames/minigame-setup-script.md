# Creating a minigame using the TUI script

There is a Python TUI script available that can generate the basic setup for new minigames.
The script is functionally identical with the [manual minigame setup](/develop/developing-minigames/create-a-minigame.md), described in the last chapter.
